...
#include "chrome/browser/unexpire_flags_gen.inc"
    ...
    {"enable-webbloat-mitigation",
     "Enable Blockage Of Unnecessarily Bloated Web Elements",
     "Enable blockage of unnecessarily bloated web elements, including large images that can force the browser to allocate hundreds of megabytes of memory.",
